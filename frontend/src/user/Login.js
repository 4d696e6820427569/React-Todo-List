  ...
  return (
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          ...
          <Form.Control type="text" value={username} name="login-username" id="login-username" onChange={handleUsername}/>
          <Form.Label htmlFor="login-password">Password: </Form.Label>
          <Form.Control type="password" name="login-password" id="login-password" value={password} onChange={handlePassword} />
